...
include '../Includes/session.php';
    ...
    $query = "SELECT tblclass.className,tblclasssection.classSection 
    FROM tblclassteacher
    INNER JOIN tblclass ON tblclass.Id = tblclassteacher.classId
    INNER JOIN tblclasssection ON tblclasssection.Id = tblclassteacher.classId
...
?>
            ...
            <!-- Class Arm Card -->
             <?php 
$query1=mysqli_query($conn,"SELECT * from tblclasssection");                       
$classSection = mysqli_num_rows($query1);
?>
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $classSection;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
